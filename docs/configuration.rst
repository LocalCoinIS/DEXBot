...
2. The Bot Strategy
   ...
   b. :doc:`follow_orders` My (Ian Haywood) main bot, an extension of stakemachine's `wall`,
      it has been used to provide liquidity on AUD:LLC. 
...
3. Strategy-specific questions
   ...
   b. The Market.
      ...
      the market for BitShares priced in US dollars is called LLC:USD. BitShares always provides a "reverse" market so
      there will be a USD:LLC with the same trades, the only difference is the prices will be the inverse (1/x) of LLC:USD.
